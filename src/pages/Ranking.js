...
class Ranking extends Component {
  render() {
    ...
    // const ranking = [{ name: 'nome-da-pessoa', score: 30, picture: '' }, { name: 'nome-da-pessoa', score: 10, picture: '' }] foi feito um teste já que o local storage não está criado
    return (
      <div className="ranking w-75 d-flex flex-column">
        <ul class="list-group">
          <li class="list-group-item active text-"><h4>Ranking</h4></li>
